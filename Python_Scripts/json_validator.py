...
env = input("Enter environment (stg, prod): ")
tenantcode = input("Enter tenant code: ")

filepath1 = f"/Users/pratikwadekar/Desktop/python_automation/config/apps/{env}/{tenantcode}"
filepath2 = f"/Users/pratikwadekar/Desktop/python_automation/config/tenants/{env}/{tenantcode}/tenant.json"
filepath3 = f"/Users/pratikwadekar/Desktop/python_automation/portfolios/{env}/portfolios.json"
